...
export default function Create({ categories }) {
    ...
    return (
        <AdminLayout title="Create Project">
            <SEO title="Create Project — Admin" />

            <div className="max-w-3xl">
                <div className="mb-8">
                    <h2 className="text-xl font-bold tracking-tight text-white/90">Create Project</h2>
                    <p className="mt-1 text-sm text-white/35">Add a new project to your portfolio.</p>
                </div>
